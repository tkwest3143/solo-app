...
class TimerModeSwitch extends HookConsumerWidget {
      ...
      child: Row(
        ...
        children: [
          _ModeButton(
            ...
            onTap: () => timerService.switchMode(TimerMode.pomodoro),
          ),
          const SizedBox(width: 4),
          _ModeButton(
            title: 'カウントアップ',
            isSelected: timerSession.mode == TimerMode.countUp,
            onTap: () => timerService.switchMode(TimerMode.countUp),
          ),
        ],
      ),
    );
...
class PomodoroPhaseIndicator extends HookConsumerWidget {
  const PomodoroPhaseIndicator({super.key});
